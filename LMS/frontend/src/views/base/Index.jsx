                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 d-flex justify-content-center">
                            ...
                            <div className="position-relative">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgbHiLvBtJOeDBnTXsgavZa6h_-eH9PvA2xQ&s" alt="girl" className="end-0 bottom-0" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center bg-primary gx-0 rounded-3 mt-5">
                        ...
                        <div className="col-lg-6 col-12 d-none d-lg-block">
                            <div className="d-flex justify-content-center pt-4">
                                {/* img */}
                                <div className="position-relative">
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOXt6Git-tVAEz7xjlq5APYfxrQX_6hh4vaw&s" alt="image" className="img-fluid mt-n8" />
                                            ...
                                            <div className="item">
                                                <div className="card">
                                                    <div className="card-body text-center p-6">
                                                        {/* img */}
                                                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaIKGVPF9rdkMAXOGRzJrN3W591sgknT6doA&s" alt="avatar" className="avatar avatar-lg rounded-circle" />
