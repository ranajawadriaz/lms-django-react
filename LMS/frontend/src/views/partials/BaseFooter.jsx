                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6 col-12 text-white">
                        ...
                        <div className="mb-4">
                            <h1>Jdot</h1>
                            <div className="mt-4">
                                <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci magnam aspernatur eum quas, mollitia dignissimos maiores excepturi. Repellendus, laboriosam! Natus nihil dolore delectus? Cumque, quaerat?</p>
                                {/* social media */}
